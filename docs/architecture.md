...
| Tray | `src/main/tray/trayManager.ts` | Menu bar icon + context menu |
...
| Song orchestrator | `src/main/services/songOrchestrator.ts` | Provider polling loop |
...
| 5 | Settings window, themes, auto-start, error states |
